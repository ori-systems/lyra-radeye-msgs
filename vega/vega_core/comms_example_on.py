...
comms = comms_lib.PD_comms_protocol('/dev/ttyACM1',False)
...
comms.set_pwm_value(comms_lib.CAM1_Light_PWM_addrs,60)
comms.set_pwm_value(comms_lib.Front_Light_PWM_addrs,60)
