...
comms = comms_lib.PD_comms_protocol('/dev/ttyACM4',False)
...
comms.set_pwm_value(comms_lib.Front_Light_PWM_addrs,180)
comms.set_pwm_value(comms_lib.Back_Light_PWM_addrs,0)
comms.set_pwm_value(comms_lib.CAM1_Light_PWM_addrs,20)
